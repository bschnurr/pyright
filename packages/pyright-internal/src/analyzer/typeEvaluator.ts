...
export function createTypeEvaluator(
    ...
    const truthinessContext: TypeEvaluatorNarrowing.TruthinessContext = {
        maxTypeRecursionCount,
        makeTopLevelTypeVarsConcrete,
        getTypedDictMembersForClass: (type, allowNarrowed) =>
            getTypedDictMembersForClass(evaluatorInterface, type, allowNarrowed),
        lookUpObjectMember,
        getTypeOfMember,
    };

    const canBeFalsy = (type: Type, recursionCount = 0) =>
        TypeEvaluatorNarrowing.canBeFalsy(truthinessContext, type, recursionCount);
    const canBeTruthy = (type: Type, recursionCount = 0) =>
        TypeEvaluatorNarrowing.canBeTruthy(truthinessContext, type, recursionCount);

    const removeTruthinessFromType = (type: Type) =>
        TypeEvaluatorNarrowing.removeTruthinessFromType(truthinessContext, type);
    const removeFalsinessFromType = (type: Type) =>
        TypeEvaluatorNarrowing.removeFalsinessFromType(truthinessContext, type);
    ...
    function getTypeOfAwaitable(typeResult: TypeResult, errorNode?: ExpressionNode): TypeResult {
        return TypeEvaluatorCore.getTypeOfAwaitableWithEvaluator(evaluatorInterface, typeResult, prefetched, errorNode);
    }
    ...
    function checkCodeFlowTooComplex(node: ParseNode): boolean {
        const complexityInfo = TypeEvaluatorFlowAnalysis.getCodeFlowComplexityInfo(node, maxCodeComplexity);

        if (complexityInfo.isTooComplex) {
            const fileInfo = AnalyzerNodeInfo.getFileInfo(node);
            addDiagnosticForTextRange(
                fileInfo,
                DiagnosticRule.reportGeneralTypeIssues,
                LocMessage.codeTooComplexToAnalyze(),
                complexityInfo.errorRange
            );
    ...
    function getReachabilityContext(): TypeEvaluatorFlowAnalysis.ReachabilityContext {
        return {
    ...
    function getNeverNarrowingContext(): TypeEvaluatorFlowAnalysis.NeverNarrowingContext {
        return {
            checkCodeFlowTooComplex,
            getCodeFlowAnalyzerForNode,
        };
    ...
    function getFlowPathContext(): TypeEvaluatorFlowAnalysis.FlowPathContext {
        return {
            checkCodeFlowTooComplex,
    ...
    function isNodeReachable(node: ParseNode, sourceNode?: ParseNode): boolean {
        return TypeEvaluatorFlowAnalysis.isNodeReachable(getReachabilityContext(), node, sourceNode);
    }

    function isAfterNodeReachable(node: ParseNode): boolean {
        return TypeEvaluatorFlowAnalysis.isAfterNodeReachable(getReachabilityContext(), node);
    }

    function getNodeReachability(node: ParseNode, sourceNode?: ParseNode): Reachability {
        return TypeEvaluatorFlowAnalysis.getNodeReachability(getReachabilityContext(), node, sourceNode);
    }

    function getAfterNodeReachability(node: ParseNode): Reachability {
        return TypeEvaluatorFlowAnalysis.getAfterNodeReachability(getReachabilityContext(), node);
    }
    ...
    function isFlowPathBetweenNodes(sourceNode: ParseNode, sinkNode: ParseNode, allowSelf = true) {
        return TypeEvaluatorFlowAnalysis.isFlowPathBetweenNodes(getFlowPathContext(), sourceNode, sinkNode, allowSelf);
    }
    ...
    function verifyRaiseExceptionType(node: ExpressionNode, allowNone: boolean) {
        TypeEvaluatorCore.verifyRaiseExceptionTypeWithEvaluator(node, allowNone, evaluatorInterface);
    }
    ...
    function isClassWithAsymmetricAttributeAccessor(classType: ClassType): boolean {
        return TypeEvaluatorCore.isClassWithAsymmetricAttributeAccessorWithEvaluator(evaluatorInterface, classType);
    }
    ...
    function adjustTypeArgsForTypeVarTuple(
        ...
        return TypeEvaluatorCore.adjustTypeArgsForTypeVarTupleWithEvaluator(evaluatorInterface, typeArgs, typeParams, errorNode);
    }
    ...
    function specializeTypeAliasWithDefaults(type: Type, errorNode: ExpressionNode | undefined) {
        return TypeEvaluatorCore.specializeTypeAliasWithDefaultsWithEvaluator(evaluatorInterface, type, errorNode, prefetched);
    }
    ...
    function getAbstractSymbolInfo(classType: ClassType, symbolName: string): AbstractSymbol | undefined {
        return TypeEvaluatorCore.getAbstractSymbolInfoWithEvaluator(evaluatorInterface, classType, symbolName);
    }
    ...
    function verifyTypeVarDefaultIsCompatible(typeVar: TypeVarType, defaultValueNode: ExpressionNode) {
        return TypeEvaluatorCore.verifyTypeVarDefaultIsCompatibleWithEvaluator(evaluatorInterface, typeVar, defaultValueNode);
    }
    ...
    function evaluateComprehensionForIf(node: ComprehensionForIfNode) {
        return TypeEvaluatorCore.evaluateComprehensionForIfWithEvaluator(evaluatorInterface, node);
    }
    ...
    function createCallableType(
        ...
        return TypeEvaluatorCore.createCallableTypeFromArgs(classType, typeArgs, errorNode, addDiagnostic);
    }
    ...
    function createOptionalType(
        ...
        return TypeEvaluatorCore.createOptionalTypeFromArgs(classType, errorNode, typeArgs, flags, prefetched, addDiagnostic);
    }
    ...
    function createSelfType(
        ...
        return TypeEvaluatorCore.createSelfTypeWithEvaluator(evaluatorInterface, classType, errorNode, typeArgs, flags);
    }
    ...
    function createRequiredOrReadOnlyType(
        ...
        return TypeEvaluatorCore.createRequiredOrReadOnlyTypeFromArgs(evaluatorInterface, classType, errorNode, typeArgs, flags);
    }
    ...
    function createAnnotatedType(
        ...
        return TypeEvaluatorCore.createAnnotatedTypeFromArgs(classType, errorNode, typeArgs, flags, addDiagnostic);
    }
    ...
    function validateAnnotatedMetadata(
        ...
        return TypeEvaluatorCore.validateAnnotatedMetadataCheck(errorNode, baseType, metaArgs);
    }
    ...
    function createSpecialType(
        ...
        return TypeEvaluatorCore.createSpecialTypeFromArgs(classType, typeArgs, addDiagnostic, paramLimit, allowParamSpec, isSpecialForm);
    }
    ...
    function createUnionType(
        ...
        return TypeEvaluatorCore.createUnionTypeFromArgs(classType, errorNode, typeArgs, flags, prefetched, addDiagnostic);
    }
    ...
    function transformTypeForTypeAlias(
        ...
        return TypeEvaluatorCore.transformTypeForTypeAliasWithEvaluator(evaluatorInterface, type, errorNode, typeAliasPlaceholder, isPep695TypeVarType, typeParamNodes);
    }
    ...
    function inferParamTypeFromDefaultValue(paramValueExpr: ExpressionNode) {
        return TypeEvaluatorCore.inferParamTypeFromDefaultValueWithEvaluator(evaluatorInterface, paramValueExpr, prefetched);
    }
    ...
    function methodAlwaysRaisesNotImplemented(functionDecl?: FunctionDeclaration): boolean {
        return TypeEvaluatorCore.methodAlwaysRaisesNotImplementedWithEvaluator(evaluatorInterface, functionDecl);
    }
    ...
    function createSpecializedClassType(
        ...
        return TypeEvaluatorCore.createSpecializedClassTypeWithEvaluator(evaluatorInterface, classType, typeArgs, flags, errorNode, prefetched);
    }
    ...
    function adjustSourceParamDetailsForDestVariadic(srcDetails: ParamListDetails, destDetails: ParamListDetails) {
        return TypeEvaluatorCore.adjustSourceParamDetailsForDestVariadicWithEvaluator(evaluatorInterface, srcDetails, destDetails);
    }
    ...
    function narrowTypeBasedOnAssignment(declaredType: Type, assignedTypeResult: TypeResult): TypeResult {
        return TypeEvaluatorNarrowing.narrowTypeBasedOnAssignment(
            {
                assignType: (destType: Type, srcType: Type) => assignType(destType, srcType),
            },
            declaredType,
            assignedTypeResult
        );
    ...
    function applyTypeArgToTypeVar(destType: TypeVarType, srcType: Type, diag: DiagnosticAddendum): Type | undefined {
        return TypeEvaluatorCore.applyTypeArgToTypeVarWithEvaluator(destType, srcType, diag, evaluatorInterface);
    }
    ...
    function narrowConstrainedTypeVar(node: ParseNode, typeVar: TypeVarType): Type | undefined {
        return TypeEvaluatorFlowAnalysis.narrowConstrainedTypeVar(
            {
                narrowConstrainedTypeVar: (flowNode: FlowNode, typeVar: TypeVarType) =>
                    codeFlowEngine.narrowConstrainedTypeVar(flowNode, typeVar),
            },
            node,
            typeVar
        );
